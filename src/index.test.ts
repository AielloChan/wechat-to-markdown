...
import { transformUrl2Markdown } from '.'

describe('transformUrl2Markdown 测试', () => {
    it('可以拉取文章标题', async () => {
        const url =
        ...
        const result = await transformUrl2Markdown(url)
    ...
    it(
        ...
        async () => {
            const url =
                'http://mp.weixin.qq.com/s?__biz=MzIyMzA5NjEyMA==&mid=2647670278&idx=1&sn=432604996bbe37adc789ce03f87d7e93&chksm=f1ce89f5fde08c1656076dfa69ca43d4e448be251df4977cdde652e7836a23f0205f869fc3b2&mpshare=1&scene=1&srcid=0408i74ORsFLkJOmnwNJWna7&sharer_shareinfo=f83f20240d56dba4508eb7a5b5932223&sharer_shareinfo_first=f83f20240d56dba4508eb7a5b5932223#rd'
            const result = await transformUrl2Markdown(url)
    ...
    it(
        ...
        async () => {
            const url =
                'http://mp.weixin.qq.com/s?__biz=MzkyOTMyMTQ5NA==&mid=2247501598&idx=1&sn=4f3407af70bc83bf85615da72880b7a3&chksm=c388638894fda1a86a79f2f6b0e8240b4c9cc7e8b23c677060fcef25edef5a7a4c2b22c1c643&mpshare=1&scene=1&srcid=04159Of4o5vW81nGa8G0ZKI6&sharer_shareinfo=816965cc25e8e9d57abaecf267202fb9&sharer_shareinfo_first=816965cc25e8e9d57abaecf267202fb9#rd'
            const result = await transformUrl2Markdown(url)
